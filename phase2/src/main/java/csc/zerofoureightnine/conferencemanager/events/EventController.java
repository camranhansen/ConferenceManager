...
public class EventController implements SubController {
     ...
     * @param eventManager Manager of the csc.zerofoureightnine.conferencemanager.events.
     */
     ...
     *
     * @param userManager Manager of the csc.zerofoureightnine.conferencemanager.users.
     * @param eventManager Manager of the csc.zerofoureightnine.conferencemanager.events.
     */
...
//                !userManager.getPermissions(speakerName).contains(Template.SPEAKER.getPermissions()))
    ...
    /**
     * Allows the user with String username to choose whether they wish to view the csc.zerofoureightnine.conferencemanager.events they are enrolled in,
     * the ones they can register for, or the entire selection of csc.zerofoureightnine.conferencemanager.events.
    ...
    /**
     * Returns the list of csc.zerofoureightnine.conferencemanager.events which the user with String username is registered for.
     *
     * @param username Username of the current user.
     */
    ...
    /**
     * Returns the list of csc.zerofoureightnine.conferencemanager.events which the user with String username can register in.
     *
     * @param username Username of the current user.
     */
    ...
    /**
     * Deletes the event identified by String eventID from the collection of all csc.zerofoureightnine.conferencemanager.events.
     *
     * @param eventID ID of the selected event.
     */
