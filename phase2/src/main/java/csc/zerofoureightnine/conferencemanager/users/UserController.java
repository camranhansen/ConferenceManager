...
public class UserController implements SubController {
    ...
    /**
     * For a given user, calls the appropriate method representing an action, based
     * on the Permission passed in
     * 
     * @param username           the username of the User attempting to perform an
     *                           action
    ...
    /**
     * Creates a new user account using the input Template to define the list of
     * Permissions, based on the user input.
     * 
    ...
    /**
     * Change the password of another user, based on the user input. Only for select
     * User types!
     */
    ...
    public void editPermissions() {
        ...
        System.out
                .println("This method has not been implemented yet, since it is not in the Phase 1 specifications. :)");
    }
