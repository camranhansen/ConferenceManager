...
public abstract class CSVGateway {
    ...
    /**
     * Instantiates a CSV based csc.zerofoureightnine.conferencemanager.gateway.
     * @throws IllegalArgumentException if {@code width} is less than 1, or if {@code filePath} is null.
     * @param width the width of one row.
     * @param filePath the path to the file that this csc.zerofoureightnine.conferencemanager.gateway handles.
     */
    public CSVGateway(int width, String filePath) {
     ...
     * Note: This does not write to the file. See {@link CSVGateway#flush()}.
     */
     ...
     *             with {@link CSVGateway#getColWidth()}.
     */
