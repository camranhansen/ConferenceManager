...
public class UserManager {
    ...
    /**
     * users stores a hashmap where the keys are usernames and the corresponding value is a User object.
     */
    ...
    /**
     * Converts the stored hashmap into a list of all users, whose data is in turn
